...
(custom-set-variables
 ...
 '(package-selected-packages
   '(desktop-environment exwm which-key visual-fill-column use-package treemacs-tab-bar treemacs-projectile treemacs-persp treemacs-magit treemacs-icons-dired treemacs-evil treemacs-all-the-icons rainbow-delimiters org-bullets ivy-rich general evil-collection elcord doom-themes doom-modeline dired-single dired-open dired-hide-dotfiles counsel command-log-mode all-the-icons-dired)))
(custom-set-faces
